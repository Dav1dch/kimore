...
class LSTMTaggerSep(nn.Module):
    ...
    def forward(self, human_inputs):
        ...
        h_0_xyz = torch.randn(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
        c_0_xyz = torch.randn(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")

        h_0_vel = torch.randn(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
        c_0_vel = torch.randn(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")

        h_0_for = torch.randn(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
        c_0_for = torch.randn(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
...
class LSTMPreSep(nn.Module):
    ...
    def forward(self, human_inputs):
        ...
        h_0_xyz = torch.ones(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
        c_0_xyz = torch.ones(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")

        h_0_vel = torch.ones(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
        c_0_vel = torch.ones(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")

        h_0_for = torch.ones(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
        c_0_for = torch.ones(self.num_directions * self.num_layers, self.batch_size, self.hidden_dim).to("cuda:0")
...
class TransformerTraggerSeq(nn.Module):
    ...
    def forward(self, human_inputs):
        ...
        h_0_xyz = torch.ones(1, 1, self.embedding_dim).to("cuda:0")
        h_0_vel = torch.ones(1, 1, self.embedding_dim).to("cuda:0")
